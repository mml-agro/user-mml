...
const ShopPage: React.FC = () => {
  ...
  const cats = [
    {k:'all',l:'All Products',c:products.length},
    {k:'sunflower',l:'Sunflower Oils',c:products.filter(p=>p.category==='sunflower').length},
    {k:'specialty',l:'Specialty Oils',c:products.filter(p=>p.category==='specialty').length},
    {k:'traditional',l:'Traditional Oils',c:products.filter(p=>p.category==='traditional').length},
  ]
  ...
  if(sort==='pl') filtered=[...filtered].sort((a,b)=>a.price['1L']-b.price['1L'])
  if(sort==='ph') filtered=[...filtered].sort((a,b)=>b.price['1L']-a.price['1L'])
